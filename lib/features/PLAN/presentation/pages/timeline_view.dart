...
// Find the last day of the month.
  ...
  void initState() {
    board = LinkedHashMap();
    for (int i = 0; i < 100; i++) {
      DateTime thisDay = DateTime.now().add(Duration(days: (-50 + i)));

      board.addAll({
        thisDay.toIso8601String(): [
          Item(
              id: i.toString(),
              listId: thisDay.toIso8601String(),
              title: "🧺 Pear",
          ...
          children: [
            Row(
              ...
              children: [
                ...
                if (isLastDayBool)
                  Text(
                    formatterMonth.format(date.add(Duration(days: 1))),
                    maxLines: 1,
                    style: TextStyle(
                      fontSize: Gparam.textSmall,
