...
class _TrackStoreMainState extends State<TrackStoreMain> {
                ...
                return DefaultTabController(
                  ...
                  child: NestedScrollView(
                                  ...
                                  Container(
                                    ...
                                    child: TextField(
                                      ...
                                      onChanged: (val) {
                                        ...
                                        print("let's search !!!");
                                        // searchBloc.add(SearchEvent(word: val));
                    ...
                    body: Stack(
                      children: [
                        TabBarView(
                          children: state.marketTabs.map((MarketTab marketTab) {
  ...
  Widget _buildSearchResults(List searchedTracks) {
    return ListView.builder(
      itemCount: searchedTracks.length,
      itemBuilder: (_, i) => Text(searchedTracks[i].name),
    );
  }

  Widget _buildSuggestions(List briefTracks) {
    return ListView.builder(
      itemCount: briefTracks.length,
      itemBuilder: (_, i) => Text(briefTracks[i].track_name),
    );
  }
}
