...
class YearPlanner extends StatefulWidget {
  ...
  @override
  _YearPlannerState createState() => _YearPlannerState();
}
...
// Find the last day of the month.
  ...
  void initState() {
    ...
    for (int i = 0; i < 12; i++) {
      print(thisMonth);
      board.addAll({
        thisMonth.toIso8601String(): [
          Item(
              id: i.toString(),
              listId: thisMonth.toIso8601String(),
              title: "🧺 Pear",
              task: TaskModel.getRandom(1)),
        ],
      });
      int lastday = DateTime(thisMonth.year, thisMonth.month + 1, 0).day;
      thisMonth = thisMonth.add(Duration(days: lastday));
    }
