...
class ConsultationChatWidget extends StatefulWidget {
  ...
  ConsultationChatWidget({Key key, this.consultation}) : super(key: key);

  @override
  _ConsultationChatWidgetState createState() => _ConsultationChatWidgetState();
}
...
class _ConsultationChatWidgetState extends State<ConsultationChatWidget> {
  ...
  void initState() {
    ...
    chatBloc = ClassChatBloc(sl(), null, widget.consultation);
  ...
  void _onScroll() {
    ...
    if (_isTop) {
      ...
      chatBloc.add(ConsultationMessagesFetched());
    }
    ;
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => chatBloc..add(ConsultationMessagesFetched()),
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          FloatingActionButton(
                            onPressed: () {
                              chatBloc.add(
                                  AddNewConsultationMessage(_messageController.text));
