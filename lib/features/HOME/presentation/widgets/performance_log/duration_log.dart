...
import 'package:sorted/features/HOME/presentation/widgets/performance_log/widgets/duration_picker.dart';
...
class DurationLog extends StatefulWidget {
  ...
  DurationLog({Key key, this.property, this.settings, this.summary, this.onLog})
      : super(key: key);

  @override
  _DurationLogState createState() => _DurationLogState();
}

class _DurationLogState extends State<DurationLog> {
  double value = 0;
                        ...
                        onChange: (val) {
                          ...
                          widget.onLog(
                              TrackLog(
                                  ...
                                  value: _duration.inMinutes.toString(),
                                  property_type: 4,
                                  time: DateTime.now(),
