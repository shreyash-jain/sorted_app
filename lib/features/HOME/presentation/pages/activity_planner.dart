...
class _ActivityPlannerState extends State<ActivityPlanner> {
  ...
  LinkedHashMap<String, String> boardTile;
  bool inAir = false;
  ...
  void initState() {
    board = LinkedHashMap();
    boardTile = LinkedHashMap();
    widget.tileWidth = Gparam.width * .9;
    boardTile.addAll({
      "Monday": "Leg Day",
      "Tuesday": "Chest Day",
      "Wednesday": "Arm Day",
...
class HeaderWidget extends StatelessWidget {
  ...
  const HeaderWidget(
      {Key key, this.title, this.context, this.inAir, this.subTitle})
      : super(key: key);
