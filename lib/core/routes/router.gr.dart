...
import '../../features/FILES/data/models/note_model.dart' as _i32;
import '../../features/FILES/data/models/notebook_model.dart' as _i33;
...
import '../../features/PLAN/data/models/goal.dart' as _i28;
import '../../features/PLAN/data/models/task.dart' as _i31;
import '../../features/PLAN/presentation/bloc/goal_page_bloc/goal_page_bloc.dart'
    as _i30;
import '../../features/PLAN/presentation/bloc/plan_bloc/plan_bloc.dart' as _i29;
...
class GoalRoute extends _i1.PageRouteInfo<GoalRouteArgs> {
  GoalRoute({_i2.Key key, _i28.GoalModel thisGoal, _i29.PlanBloc planBloc})
      : super(name,
            path: '/goal-page',
            args: GoalRouteArgs(
...
class GoalRouteArgs {
  ...
  final _i28.GoalModel thisGoal;

  final _i29.PlanBloc planBloc;
}

class SelectCover extends _i1.PageRouteInfo<SelectCoverArgs> {
  SelectCover({_i2.Key key, _i30.GoalPageBloc goalBloc})
      : super(name,
            path: '/select-cover',
...
class SelectCoverArgs {
  ...
  final _i30.GoalPageBloc goalBloc;
}

class TaskRoute extends _i1.PageRouteInfo<TaskRouteArgs> {
  TaskRoute({_i2.Key key, _i31.TaskModel thisGoal, _i29.PlanBloc planBloc})
      : super(name,
            path: '/task-page',
            args: TaskRouteArgs(
                key: key, thisGoal: thisGoal, planBloc: planBloc));
...
class NoteMain extends _i1.PageRouteInfo<NoteMainArgs> {
  NoteMain({_i2.Key key, _i32.NoteModel note})
      : super(name,
...
class NotesHubRoute extends _i1.PageRouteInfo<NotesHubRouteArgs> {
  NotesHubRoute({_i2.Key key, _i33.NotebookModel thisNotebook})
      : super(name,
            path: '/notes-hub-page',
...
class NotesHubRouteArgs {
  ...
  final _i33.NotebookModel thisNotebook;
}
