...
class NoteComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String f_content = "";
    List<dynamic> list = jsonDecode(noteData.content);
    for (var i = 0; i < list.length; i++) {
      print("printthis: " + list[i].toString() );
      var j_data = list[i];
      var cont = j_data['insert'] ;
      f_content = f_content + cont.toString().trim() + " ";
    }


    String content_show = f_content;
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      '${content_show.trim().split('\n').first.length <= 60 ? content_show.trim().split('\n').first : content_show.trim().split('\n').first.substring(0, 60) + '...'}',
                      style:
